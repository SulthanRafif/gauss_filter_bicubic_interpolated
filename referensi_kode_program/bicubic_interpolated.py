...
# for this task
img = cv2.imread("./image/teeth.jpg")
...
cv2.imwrite("./interpolated/teeth_bicubic_interpolated.png", dst)
bicubicImg = cv2.imread("./interpolated/teeth_bicubic_interpolated.png")
